...
import {
  ...
  useFormControl
} from "./chunk-AA7O6XTI.js";
import {
  createSvgIcon
} from "./chunk-GYDOROM5.js";
import {
  useThemeProps
} from "./chunk-BLQQFP3X.js";
import {
  require_createStyled,
  styled_default
} from "./chunk-FUA4JZVQ.js";
import {
  shouldForwardProp,
  useMediaQuery,
  useRtl
} from "./chunk-DRDBUDI2.js";
import {
  _objectWithoutPropertiesLoose,
  clsx_default,
  require_prop_types,
  require_react_is
} from "./chunk-V2XBGPF4.js";
import {
  _extends,
  init_extends
...
var PickerContext = React15.createContext(null);
var usePickerContext = () => {
  const value = React15.useContext(PickerContext);
  if (value == null) {
...
var IsValidValueContext = React16.createContext(() => true);
function useIsValidValue() {
  return React16.useContext(IsValidValueContext);
}

// node_modules/@mui/x-date-pickers/esm/internals/hooks/useNullableFieldPrivateContext.js
var React17 = __toESM(require_react(), 1);
var PickerFieldPrivateContext = React17.createContext(null);
function useNullableFieldPrivateContext() {
  return React17.useContext(PickerFieldPrivateContext);
}
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const utils = useUtils();
  const cleanDate = React27.useMemo(() => !utils.isValid(date) ? null : date, [utils, date]);
...
var useControlledValue = ({
  ...
  const inputTimezone = React32.useMemo(() => valueManager.getTimezone(utils, valueWithInputTimezone), [utils, valueManager, valueWithInputTimezone]);
  ...
  const valueWithTimezoneToRender = React32.useMemo(() => valueManager.setTimezone(utils, timezoneToRender, valueWithInputTimezone), [valueManager, utils, timezoneToRender, valueWithInputTimezone]);
...
function useValueAndOpenStates(parameters) {
  ...
  const {
    current: defaultValue
  } = React33.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React33.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React33.useMemo(() => valueManager.cleanValue(utils, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [utils, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React34.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React34.useState(null);
  const popupRef = React34.useRef(null);
  const fieldRef = React34.useRef(null);
  const rootRefObject = React34.useRef(null);
  ...
  const ownerState = React34.useMemo(() => ({
  ...
  const triggerStatus = React34.useMemo(() => {
  ...
  const contextValue = React34.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React34.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React34.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React35.memo(PickersActionBarComponent);
...
var usePickerLayout = (props) => {
  ...
  const ownerState = React37.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersLayout = React38.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime8.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime8.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime8.jsxs)(React38.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime8.jsxs)(React38.Fragment, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime9.jsxs)(React40.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime9.jsxs)(React40.Fragment, {
  children: [(0, import_jsx_runtime9.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime9.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var PickersSectionList = React41.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime10.jsx)(React41.Fragment, {
...
var PickersOutlinedInput = React45.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime13.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime13.jsxs)(React45.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
function useApplyDefaultValuesToDateFieldInternalProps(internalProps) {
  ...
  return React53.useMemo(() => _extends({}, internalProps, validationProps, {
...
function useApplyDefaultValuesToTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React54.useMemo(() => internalProps.ampm ?? utils.is12HourCycleInCurrentLocale(), [internalProps.ampm, utils]);
...
var useFieldState = (parameters) => {
  ...
  const error = React55.useMemo(() => {
    if (errorProp !== void 0) {
      return errorProp;
    }
    return hasValidationError;
  }, [hasValidationError, errorProp]);
  const localizedDigits = React55.useMemo(() => getLocalizedDigits(utils), [utils]);
  const sectionsValueBoundaries = React55.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React55.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    utils,
  ...
  const parsedSelectedSections = React55.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
  const activeSectionIndex = parsedSelectedSections === "all" ? 0 : parsedSelectedSections;
  const sectionOrder = React55.useMemo(() => getSectionOrder(state.sections, isRtl && !enableAccessibleFieldDOMStructure), [state.sections, isRtl, enableAccessibleFieldDOMStructure]);
  const areAllSectionsEmpty = React55.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React55.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React56.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React56.useMemo(() => {
...
function useFieldHiddenInputProps(parameters) {
  ...
  const valueStr = React57.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  return {
    value: valueStr,
...
function useFieldSectionContainerProps(parameters) {
  ...
  return React58.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  return React59.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const sectionListRef = React60.useRef(null);
  const handleSectionListRef = useForkRef(sectionListRefProp, sectionListRef);
  const domGetters = React60.useMemo(() => ({
...
var useFieldV6TextField = (parameters) => {
  ...
  const openPickerAriaLabel = useOpenPickerButtonAriaLabel2(value);
  const sections = React61.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const valueStr = React61.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React61.useEffect(() => {
  ...
  const inputMode = React61.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
...
@mui/utils/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4XK3WXSN.js.map
